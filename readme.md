...
## How does it work?
When you open a page it searches for its ip address in the database and if there is one then it sends a GET request to it. The response will contain all things about the page.
